"""Trimmed from hd2-audio-modder/util.py: only what the audio-patching oracle
needs (MemoryStream, padding/hash helpers, assert helpers). GUI/import-format
helpers (parse_filename, alphanum_key, ...) are dropped.
"""
...
class MemoryStream:
    """
    Modified from https://github.com/kboykboy2/io_scene_helldivers2 with
    permission from kboykboy.
    """
